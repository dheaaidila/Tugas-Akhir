<x-app>
    ...
    <a href="{{ url('admin/ck') }}" class="btn btn-primary btn-tone btn-sm mt-4"><i class="fas fa-arrow-left"></i>
        Kembali</a>
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <dd>Rp. {{ number_format($ck->jumlah_uang) }}</dd>
                </div>

                <div class="col-md-6">
                    <dt class="font-weight-bold">FILE</dt>
                    <dd>
                        <button class="btn btn-primary lihat-pdf-btn" data-url="{{ url($ck->url_pdf) }}">
                            FILE
                        </button>
                    </dd>
                </div>
